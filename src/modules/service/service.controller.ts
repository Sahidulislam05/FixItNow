...
const updateMyService = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    const technicianId = req.user?.id as string;
    const serviceId = req.params.id as string;
    ...
    const updatedService = await serviceService.updateMyServiceInDB(
      serviceId,
      technicianId,
      payload,
    );
...
const deleteMyService = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    const technicianId = req.user?.id as string;
    const serviceId = req.params.id as string;
