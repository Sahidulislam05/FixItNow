...
// z.enum এর জন্য কমপক্ষে একটা ভ্যালু লাগে বলে টাইপ-সেফ টিউপল কাস্ট করা হচ্ছে
...
const cancelBookingValidationSchema = z.object({
    body: z.object({
        cancelReason: z.string().trim().max(500, "Cancel reason can not be more than 500 characters").optional(),
    }),
});
