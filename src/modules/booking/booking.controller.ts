...
const createBooking = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const booking = await bookingService.createBookingIntoDB(customerId, payload);
...
const getBookingById = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (!bookingId) {
        throw new AppError(httpStatus.BAD_REQUEST, "Booking ID required in params");
    }

    const booking = await bookingService.getBookingByIdFromDB(bookingId, userId, role);
...
const cancelBooking = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const cancelledBooking = await bookingService.cancelBookingByCustomerInDB(bookingId, customerId, cancelReason);
...
const updateBookingStatus = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const updatedBooking = await bookingService.updateBookingStatusByTechnicianInDB(bookingId, technicianId, status);
...
const getTechnicianBookings = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const result = await bookingService.getTechnicianBookingsFromDB(technicianId, query);
